...
export function InboxPage({
  ...
  return (
    ...
    <MotionConfig reducedMotion="user">
      {/*
        A row: the page, and the drawer taking width from it. From `xl` up the drawer is in this
        flow and the page genuinely narrows; below it the drawer covers instead, because there is
        no width on a phone to give away - see InboxDrawer.
      */}
      <div className="theme-ink flex w-full bg-background text-foreground xl:h-dvh xl:overflow-hidden">
        ...
        {/*
          ...
          jobs are different: the status line sits on the title's baseline, and the filters
